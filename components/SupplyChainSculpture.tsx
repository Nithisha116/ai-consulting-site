...
export default function SupplyChainSculpture() {
  ...
  const nodes: NodeItem[] = [
    ...
    { id: "supplier", label: "03 SUPPLIER FLOW", subtitle: "Automated PO generation", x: 77, y: 24, details: "Automatically drafts purchase orders when any raw material is projected to run out within its supplier's lead time.", icon: <Truck className="w-4 h-4 text-indigo-500" /> },
